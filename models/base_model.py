...
class BaseModel:
    """
    Parent class to take care of the initialization, serialization
    ...
    def to_dict(self):
        ...
        new_dct['created_at'] = self.updated_at.strftime("%Y-%m-%dT%H:%M:%S.%f")
        new_dct['updated_at'] = self.created_at.strftime("%Y-%m-%dT%H:%M:%S.%f")
