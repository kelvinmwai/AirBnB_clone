...
class HBNBCommand(cmd.Cmd):
    ...
    def do_all(self, line):
        """Command to print all instances whether or not based on class name"""
        str_list = []
    ...
    def default(self, line):
        """Parse and interprete a line if not found on regular commands"""
        count = 0
...
if __name__ == '__main__':
    """initialize_storage() Call the initializationfunction"""
    HBNBCommand().cmdloop()
